...
/**
 * This class aims to create a sample GraphDb on Azure CosmosDb
 * 
 * @author rodrigo.pereira@microsoft.com
 *
 */
public class MainCosmosDb {

	
	public static void main(String[] args) throws FileNotFoundException {
        Cluster cluster = Cluster.build(new File("src/main/java/remote.yaml")).create();
        Client client = cluster.connect();
        
        for(int i=0; i < 1000000; i++) {
        	client.submit("g.addV(\"person\").property(\"name\", \"bob"+i+"\").as(\"bob"+i+"\").\r\n" + 
